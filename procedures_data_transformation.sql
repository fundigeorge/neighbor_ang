-- Create a new stored procedure called 'drop_coord_columns' in schema 'dbo'
    -- Drop the stored procedure if it already exists
    IF EXISTS (
    SELECT *
        FROM INFORMATION_SCHEMA.ROUTINES
    WHERE SPECIFIC_SCHEMA = N'dbo'
        AND SPECIFIC_NAME = N'drop_coord_columns'
    )
    DROP PROCEDURE dbo.drop_coord_columns
    GO
    -- Create the stored procedure in the specified schema
    CREATE PROCEDURE dbo.drop_coord_columns
    ...
    EXECUTE dbo.drop_coord_columns 1 /*value_for_param1*/, 2 /*value_for_param2*/
    GO
...
--Create a new stored procedure called 'add_coord_columns' in schema 'dbo'
    ...
    AS
        ...
        onedp_lat FLOAT, onedp_lon FLOAT, twodp_lat FLOAT, twodp_lon FLOAT, coverage NVARCHAR(50)
